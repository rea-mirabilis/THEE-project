...
#=======
output <- simulate_pop_diploid(N_RR = 0, N_Rr=0, N_rr=1000, decay_rate=0.175, sel_coeffs, mut_rate=0.05,max_gen)
#>>>>>>> Stashed changes
# show the last few lines of the data table
print(tail(output))
# plot the output - note that the plot range and the x axis have to be adjusted based on the length of the table
...
seltable <- create_sel_coeffs(s_number = 50, biggest_S = 3, inc = 0.0045)
...
#call the seltable here.
seltable_R <- create_sel_coeffs_R(s_number = 50, biggest_S = 3, inc = 0.0045)
...
plot(pr * 100, type = "b", col = "blue", pch = 15, xlab = "R advantage",
     ylab = "Success Rate(%)", main = "Tetraploid", ylim = c(0, 100), las = 1)

plot(pr_diploid * 100, type = "b", col = "red", pch = 15, xlab = "R Advantage",
     ylab = "Success Rate(%)", main = "Diploid", ylim = c(0, 100), las = 1)
